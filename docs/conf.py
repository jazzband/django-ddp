# -*- coding: utf-8 -*-
#
# Django DDP documentation build configuration file, created by
...
project = u'Django DDP'
copyright = u'2015, Tyson Clugg'
...
htmlhelp_basename = 'DjangoDDPdoc'
...
latex_documents = [
  ('index', 'DjangoDDP.tex', u'Django DDP Documentation',
   u'Tyson Clugg', 'manual'),
]
...
man_pages = [
    ('index', 'djangoddp', u'Django DDP Documentation',
     [u'Tyson Clugg'], 1)
]
...
texinfo_documents = [
  ('index', 'DjangoDDP', u'Django DDP Documentation',
   u'Tyson Clugg', 'DjangoDDP', 'One line description of project.',
   'Miscellaneous'),
]
